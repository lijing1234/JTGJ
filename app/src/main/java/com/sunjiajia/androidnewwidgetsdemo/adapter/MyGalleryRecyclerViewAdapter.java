 ...
 */
public class MyGalleryRecyclerViewAdapter extends SurperRecyclerView.Adapter<MyRecyclerViewHolder> implements View.OnClickListener {
...
//    }
    ...
    public MyGalleryRecyclerViewAdapter(List<String> list, Context mContext) {
...
//        }
    ...
    public void onBindViewHolder(final MyRecyclerViewHolder holder, final int position) {
        ...
        Glide.with(mContext)
                .load(mDatas.get(position).toString())
