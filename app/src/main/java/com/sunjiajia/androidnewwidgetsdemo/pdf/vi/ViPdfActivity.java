...
package com.sunjiajia.androidnewwidgetsdemo.pdf.vi;
...
public class ViPdfActivity extends AppCompatActivity {
...
//        String position = getIntent().getStringExtra("a");
        ...
        switch (posi) {
            case 0:
                FILE_NAME = "/JT/pdf/vi/02企业VI手册.pdf";
